...
namespace TestApi.Controllers.LanguagesControllerTests.Tests_Invalides
{
    ...
    public class PostLanguagesErrorTests
    {
        private readonly CustomWebApplicationFactory<Program> _factory;
        private readonly HttpClient _client;


        public PostLanguagesErrorTests(CustomWebApplicationFactory<Program> factory)
        {
            _factory = factory;
    ...
    new List<object[]>
    {
        ...
        public async Task PostLanguages_ReturnsBadRequest_WhenDataIsInvalid(string _name)
        {
            // Arrange
            // Pour le test POST
